...
k13_pr <- formula(female_share_prod    ~ d3a * eac_exporter  + capital_city + multi_establ + intern_certif + l4a)
k13_np <- formula(female_share_nonprod ~ d3a * eac_exporter  + capital_city + multi_establ + intern_certif+ industry + l4a)
...
k13_pr_r1 <-  lm(k13_pr, data = Kenya_2013)
k13_pr_r2 <- glm(k13_pr, data = Kenya_2013, family = quasibinomial(link='logit') )
k13_np_r1 <-  lm(k13_np, data = Kenya_2013)
k13_np_r2 <- glm(k13_np, data = Kenya_2013, family = quasibinomial(link='logit') )
