...
# estimate models
m1_r1 <- lm(m1, data = Uganda_2013)
m1_r2 <- glm(m1, data = Uganda_2013, family = quasibinomial(link='logit') )
m2_r1 <- lm(m2, data = Uganda_2013)

m21_r1 <- lm(m21, data = Uganda_2006)
m22_r1 <- lm(m22, data = Uganda_2006)
